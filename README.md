...
- Local refinement in underbody, rear wake, and wheel regions
...
- Integrated aerodynamic forces: drag and lift/downforce
...
Visualization includes pressure contours, velocity magnitude, and wake and vortex structures.

## Machine Learning Pipeline

### Objective
Use CFD-generated data to learn aerodynamic trends, predict aerodynamic metrics, and demonstrate physics-informed data modeling.
...
Example notebook: aero_ML.ipynb
...
Modern motorsport and engineering increasingly combine CFD, data science, and machine learning.  
...
- Surrogate models for real-time aerodynamic prediction
...
PDF – CFD Analysis of an F1-Style Vehicle Using OpenFOAM  
docs/CFD%20Analysis%20of%20an%20F1-Style%20Vehicle%20Using%20OpenFOAM.pdf
